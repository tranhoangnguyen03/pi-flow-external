...
export const EXTERNAL_HARNESSES = ["agy", "claude", "codex", "grok", "muse", "opencode"] as const;
...
export interface SubagentProfile {
  ...
  /**
   * Which configuration to use. For claude/codex/agy/grok/muse/opencode this always equals
