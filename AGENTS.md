...
- Profiles with `backend: pi` or a missing backend are filtered out and rejected; `/external profile clean-up` archives such legacy files to `subagents/archive/` after user confirmation.
