...
- External backends use their own tools and dangerous/no-approval modes. Run them only in trusted repositories and state whether the task is read-only or may edit files.
